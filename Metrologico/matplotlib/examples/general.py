...
axes.plot([1, 2, 3, 4], [1, 4, 2, 3])  # Plot some data on the axes.
plt.show()

# Create a figure containing a single axes.
fig2, ax2 = plt.subplots(2, 3)
print(ax2)
ax2[0][1].plot([1, 2, 3, 4], [1, 4, 2, 3])  # Plot some data on the axes.
...
ax3.plot(x, x, label='linear')  # Plot some data on the axes.
ax3.plot(x, x ** 2, label='quadratic')  # Plot more data on the axes...
ax3.plot(x, x ** 3, label='cubic')  # ... and some more.
